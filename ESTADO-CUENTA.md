...
> **Última lectura: 2026-09-22 18:27 Bogotá.** Se actualiza **cada hora**. Para un dato urgente usá el botón manual del Action.
...
|---|---|
| **saldo ahora** | **$60,028** |
| gastado hoy (hasta las 18h) | $123,598 |
| presupuesto activo | $155,000/día |
| cierre proyectado del día | $149,216 |
| saldo proyectado a medianoche | $34,410 |
| objetivo (cubrir un día de 143% + colchón) | $241,650 |

### 🟠 Recargar $58,024 para cubrir un día malo
...
| 2026-09-22 **HOY** | $123,598 | 114 | **$1,084** | $4,509 | 4.16 |

🟢 **Hoy va mejor que ayer a la misma hora** ($1,084 vs $1,193).
...
|---|---|---|---|
| **CPM** (el precio de la subasta) | $4,509 | ~$3.615 | 🔴 alto |
...
|---|---|---|---|---|---|---|
| Domiciliarios - Expancion - API | $40,000 | $31,835 | 80% | 26 | $1,224 | 3.01 |
| TEST Creativos - API | $40,000 | $31,826 | 80% | 26 | $1,224 | 7.21 |
| Domiciliarios - API | $35,000 | $27,104 | 77% | 29 | $935 | 3.96 |
| Domiciliarios VIDEO - API | $20,000 | $17,838 | 89% | 17 | $1,049 | 4.56 |
| Motorizados - API | $20,000 | $14,995 | 75% | 11 | $1,363 | 2.68 |
...
|---|---|---|---|---|---|
| **TRADICIONAL** | $123,598 | 114 | **$1,084** | $2,402 | **45%** 🟢 |

| | |
|---|---|
| CPA implícito (cierre 8.4%) | **$12,907**/pedido |
| utilidad estimada de lo que va del día | **$104,541** |
...
|---|---|---|---|---|---|---|---|
| Domiciliarios - Expancion - API | — | — | — | — | — | $1,224 |  |
| TEST Creativos - API | — | — | — | — | — | $1,224 |  |
| Domiciliarios - API | — | — | — | — | — | $935 |  |
| Domiciliarios VIDEO - API | — | — | — | — | — | $1,049 |  |
| Motorizados - API | — | — | — | — | — | $1,363 |  |
...
| conjunto | 09-17 | 09-18 | 09-19 | 09-20 | 09-21 | 09-22 | |
|---|---|---|---|---|---|---|---|
| Domiciliarios - Expancion - API | — | — | — | — | — | 3.01 |  |
| TEST Creativos - API | — | — | — | — | — | 7.21 |  |
| Domiciliarios - API | — | — | — | — | — | 3.96 |  |
| Domiciliarios VIDEO - API | — | — | — | — | — | 4.56 |  |
| Motorizados - API | — | — | — | — | — | 2.68 |  |
...
| 2026-09-21 | $160,949 | 146 | $1,102 | $3,926 | 3.56 | $131,230 |
